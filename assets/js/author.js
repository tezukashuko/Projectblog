...
let offset = 0
let limit = 2
let postplaceid = document.getElementsByClassName('authorpost')[0].id;
let user_id = postplaceid.split('_')[1];
getPosts('date_create desc', limit, offset, postplaceid, user_id);
...
function getPosts(orderby, limit, offset, postplaceid, user_id) {
    let xhr = new XMLHttpRequest();
    xhr.open("get", `./getpost.php?orderby=${orderby}&limit=${limit}&offset=${offset}&user_id=${user_id}&getpostsbyauthor=`, true);
